package com.example.attpspringboot.storage.services;

import com.example.attpspringboot.storage.controllers.StorageController;
import com.example.attpspringboot.storage.exceptions.StorageBadRequesException;
import com.example.attpspringboot.storage.exceptions.StorageInternalException;
import com.example.attpspringboot.storage.exceptions.StorageNotFoundException;
...
public class FileSystemStorageService implements StorageService {
     ...
     * @throws StorageBadRequesException si el fichero está vacío
     * @throws StorageInternalException   si hay un error al almacenar el fichero
     * @throws StorageBadRequesException si el fichero contiene caracteres no permitidos
     */
    @Override
    public String store(MultipartFile file) {
        ...
        try {
            if (file.isEmpty()) {
                throw new StorageBadRequesException("Fichero vacío " + filename);
            }
            if (filename.contains("..")) {
                // This is a security check
                throw new StorageBadRequesException(
